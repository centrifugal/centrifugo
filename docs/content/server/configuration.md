...
This option sets a time of sequence data expiration in Engine. For example sequence meta key in Redis is a HASH that contains current sequence number in channel and epoch value. By default sequence data for channels do not expire.
