...
func NewPopulatedReply(r randyApi, easy bool) *Reply {
	...
	this.Result = github_com_centrifugal_centrifugo_lib_proto.NewPopulatedRaw(r)
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedHistoryResult(r randyApi, easy bool) *HistoryResult {
	...
	if r.Intn(10) != 0 {
		v6 := r.Intn(5)
		this.Publications = make([]*proto2.Publication, v6)
		for i := 0; i < v6; i++ {
...
func NewPopulatedNodeResult(r randyApi, easy bool) *NodeResult {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v9; i++ {
			v10 := randStringApi(r)
			this.Metrics[v10] = int64(r.Int63())
			if r.Intn(2) == 0 {
				this.Metrics[v10] *= -1
			}
		}
...
func randFieldApi(dAtA []byte, r randyApi, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateApi(dAtA, uint64(v12))
	case 1:
		dAtA = encodeVarintPopulateApi(dAtA, uint64(key))
...
func (m *Reply) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v github_com_centrifugal_centrifugo_lib_proto.Raw
			m.Result = &v
...
var fileDescriptorApi = []byte{
	...
	,
}
