...
func (MessageType) EnumDescriptor() ([]byte, []int) { return fileDescriptorClient, []int{0} }
...
type Message struct {
	...
	Channel string      `protobuf:"bytes,2,opt,name=Channel,proto3" json:"c,omitempty"`
	Data    Raw         `protobuf:"bytes,3,opt,name=Data,proto3,customtype=Raw" json:"d"`
}
...
func (m *ConsumeRequest) String() string            { return proto1.CompactTextString(m) }
func (*ConsumeRequest) ProtoMessage()               {}
func (*ConsumeRequest) Descriptor() ([]byte, []int) { return fileDescriptorClient, []int{36} }
...
func init() {
	...
	proto1.RegisterType((*ConsumeRequest)(nil), "proto.ConsumeRequest")
...
func (this *ConsumeRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ConsumeRequest)
	if !ok {
		that2, ok := that.(ConsumeRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func NewPopulatedConsumeRequest(r randyClient, easy bool) *ConsumeRequest {
	this := &ConsumeRequest{}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
var fileDescriptorClient = []byte{
	...
	,
}
