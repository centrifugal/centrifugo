...
type SubscribeResult struct {
	...
	Messages  []*proto1.Publication `protobuf:"bytes,3,rep,name=Messages" json:"Messages,omitempty"`
}
...
func (m *SubscribeResult) GetMessages() []*proto1.Publication {
	if m != nil {
		return m.Messages
	}
	return nil
...
type HistoryResult struct {
	Data []*proto1.Publication `protobuf:"bytes,1,rep,name=Data" json:"data"`
}
...
func (m *HistoryResult) GetData() []*proto1.Publication {
	if m != nil {
		return m.Data
	}
	return nil
...
func NewPopulatedSubscribeResult(r randyClient, easy bool) *SubscribeResult {
	...
	if r.Intn(10) != 0 {
		v3 := r.Intn(5)
		this.Messages = make([]*proto1.Publication, v3)
		for i := 0; i < v3; i++ {
			this.Messages[i] = proto1.NewPopulatedPublication(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedHistoryResult(r randyClient, easy bool) *HistoryResult {
	...
	if r.Intn(10) != 0 {
		v6 := r.Intn(5)
		this.Data = make([]*proto1.Publication, v6)
		for i := 0; i < v6; i++ {
			this.Data[i] = proto1.NewPopulatedPublication(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func (m *SubscribeResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Messages = append(m.Messages, &proto1.Publication{})
...
func (m *HistoryResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Data = append(m.Data, &proto1.Publication{})
...
var fileDescriptorClient = []byte{
	...
	,
}
