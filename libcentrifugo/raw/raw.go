...
func (r Raw) Equal(other Raw) bool {
	// TODO: this is only used in gogo protobuf autogenerated tests for jsonpb.
	// At moment there is an issue with custom []byte type: see https://github.com/gogo/protobuf/issues/220
	// so tests fail. As soon as there are news on that issue this must be fixed.
	return true
