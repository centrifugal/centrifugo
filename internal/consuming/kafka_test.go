...
func (m *MockDispatcher) DispatchPublication(ctx context.Context, data []byte, idempotencyKey string, delta bool, channels ...string) error {
	return m.onDispatchPublication(ctx, data, idempotencyKey, delta, channels...)
}
...
func TestKafkaConsumer_RetryAfterDispatchError(t *testing.T) {
	...
	consumer, err := NewKafkaConsumer(
		"test", configtypes.ConsumerContentModeMethodPayload, uuid.NewString(),
