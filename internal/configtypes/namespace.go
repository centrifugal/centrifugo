...
type ChannelOptions struct {
	...
	HistoryTTL time.Duration `mapstructure:"history_ttl" json:"history_ttl" envconfig:"history_ttl"`
	...
	HistoryMetaTTL time.Duration `mapstructure:"history_meta_ttl" json:"history_meta_ttl" envconfig:"history_meta_ttl"`
